...
{
    public class ChooseBranch_Adapter_Main : RecyclerView.Adapter
    {
        ...
        public ChooseBranch_Adapter_Main(ListBranch l)
        {
            listitem = l;
        }
        ...
        public override void OnBindViewHolder(RecyclerView.ViewHolder holder, int position)
        {
            ...
            var index = ChooseBranchActivity.listChooseBranch.FindIndex(x => x.SysBranchID == listitem[position].SysBranchID);
            if (index == -1)
            {
