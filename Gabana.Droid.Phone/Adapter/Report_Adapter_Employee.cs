...
{
    public class Report_Adapter_Employee : RecyclerView.Adapter
    {
        ...
        public override void OnBindViewHolder(RecyclerView.ViewHolder holder, int position)
        {
            try
            {
                ...
                var index = ReportEmployeeActivity.listChooseEmployee.FindIndex(x => x.UserName == listEmployee[position].UserName);
                if (index == -1)
                {
