...
namespace Gabana.Droid
{
    ...
    public class ChangePasswordActivity : AppCompatActivity
    {
        ...
        public static string typepagepincode = string.Empty;
        ...
        protected async override void OnCreate(Bundle savedInstanceState)
        {
            try
            {
                ...
                SetContentView(Resource.Layout.changepass_activity_main);
                ...
                _ = TinyInsights.TrackPageViewAsync("OnCreate : ChangePasswordActivity");
            }
            catch (Exception ex)
            {
        ...
        private async void BtnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (LocalUseraccount.FUsePincode != UsePincode || LocalUseraccount.PinCode != NewPincode)
                {
                    ...
                    Gabana.Model.UserAccountInfo Update = new Gabana.Model.UserAccountInfo();
                    if (Update == null)
                    {
                        return;
                    }

                    Update.UserName = useraccountData?.UserName;
                    Update.MainRoles = useraccountData?.MainRoles;
                    Update.UserAccessProduct = useraccountData.UserAccessProduct;
                    Update.FullName = useraccountData?.FullName;
                    Update.MerchantID = useraccountData.MerchantID;
                    Update.CreatedTime = useraccountData.CreatedTime;
                    Update.FStatus = useraccountData.FStatus;
                    Update.LastAccessTime = useraccountData.LastAccessTime;
                    Update.LastModifyTime = useraccountData.LastModifyTime;
                    Update.ListSeniorStaff = useraccountData.ListSeniorStaff;
                    Update.ListUserAccessProduct = useraccountData.ListUserAccessProduct;
                    Update.Mobile = useraccountData.Mobile;
                    Update.PasswordHash = useraccountData.PasswordHash;
                    Update.PasswordSalt = useraccountData.PasswordSalt;
                    Update.ShopID = useraccountData.ShopID;
                    Update.TryNextTime = useraccountData.TryNextTime;
                    Update.TryPassCount = useraccountData.TryPassCount;
                    ...
                    DataCashingAll.UserAccountInfo.Add(Update);
