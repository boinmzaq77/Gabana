...
{
    public class Customer_Dialog_AddImage : Android.Support.V4.App.DialogFragment
    {
        ...
        public static Customer_Dialog_AddImage NewInstance()
        {
            var frag = new Customer_Dialog_AddImage { Arguments = new Bundle() };
            return frag;
        }
        ...
        {
            AddCustomerActivity.addCustomer.CheckPermission();
