...
{
    public class Item_Dialog_DeleteToppping : Android.Support.V4.App.DialogFragment
    {
        ...
        public static Item_Dialog_DeleteToppping NewInstance(int sysitemID, string _page)
        {
            SysitemID = sysitemID;
            Page = _page;
            var frag = new Item_Dialog_DeleteToppping { Arguments = new Bundle() };
            return frag;
        }
