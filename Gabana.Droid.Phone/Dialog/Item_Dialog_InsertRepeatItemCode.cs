...
{
    public class Item_Dialog_InsertRepeatItemCode : Android.Support.V4.App.DialogFragment
    {
        Button btn_cancel, btn_save;
        static string DetailItem, Page, Detail, Event;
        ...
        public static Item_Dialog_InsertRepeatItemCode NewInstance(string _page, string _itemname, string _detailinsert, string _event)
        {
            Page = _page;//ItemName or Itemcode
            DetailItem = _itemname;
            Detail = _detailinsert;
            Event = _event;
            var frag = new Item_Dialog_InsertRepeatItemCode { Arguments = new Bundle() };
            return frag;
        }
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            try
            {
                ...
                var text2 = GetText(Resource.String.dialog_additem_itemcode);
        ...
        async void DetailInsert(bool checkManageStock, Item DetailITem, string Stock, string minimumstock)
        {
            ...
            catch (Exception ex)
            {
                ...
                _ = TinyInsights.TrackPageViewAsync("DetailInsert at item_dialog_insertrepeatitemcode");
                Toast.MakeText(Application.Context, Application.Context.GetString(Resource.String.cannotinsert), ToastLength.Short).Show();
            }
        }
