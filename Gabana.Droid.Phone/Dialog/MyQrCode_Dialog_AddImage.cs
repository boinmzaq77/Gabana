...
{
    public class MyQrCode_Dialog_AddImage : Android.Support.V4.App.DialogFragment
    {
        ...
        public static MyQrCode_Dialog_AddImage NewInstance()
        {
            var frag = new MyQrCode_Dialog_AddImage { Arguments = new Bundle() };
            return frag;
        }
        ...
        {
            AddmyQRActivity.activity.CheckPermission();
