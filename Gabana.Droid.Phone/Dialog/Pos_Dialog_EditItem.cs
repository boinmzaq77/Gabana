...
//{
//    public class Pos_Dialog_EditItem : Android.Support.V4.App.DialogFragment
//    {
...
//        public static Pos_Dialog_EditItem NewInstance()
//        {
//            var frag = new Pos_Dialog_EditItem { Arguments = new Bundle() };
//            return frag;
//        }
...
//                    try
//                    {
//                        string conColor = Utils.SetBackground(Convert.ToInt32(DataCashing.DialogShowItem.Colors));
...
//                    txtPrice.Text = CURRENCYSYMBOLS + " " + price.ToString("#,###.##");
//                }
...
//                //Pos_Dialog_DeleteItem dialogDelete = new Pos_Dialog_DeleteItem();
...
//                var IntentEdit = new Intent(Application.Context, typeof(AddItemActivity));
