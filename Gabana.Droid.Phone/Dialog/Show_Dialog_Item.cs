...
{
    public class Show_Dialog_Item : Android.Support.V4.App.DialogFragment
    {
        ...
        public static Show_Dialog_Item NewInstance(string _path)
        {
            path = _path;
            var frag = new Show_Dialog_Item { Arguments = new Bundle() };
            return frag;
        }

        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            View view = inflater.Inflate(Resource.Layout.dialog_item, container, false);
            try
            {
