...
{
    public class Topping_Dialog_AddImage : Android.Support.V4.App.DialogFragment
    {
        ...
        public static Topping_Dialog_AddImage NewInstance()
        {
            var frag = new Topping_Dialog_AddImage { Arguments = new Bundle() };
            return frag;
        }
        ...
        {
            AddExtraToppingActivity.addExtra.CheckPermission();
            AddExtraToppingActivity.addExtra.GalleryOpen();
            MainDialog.CloseDialog();
        }
        ...
        {
            AddExtraToppingActivity.addExtra.CheckPermission();
            AddExtraToppingActivity.addExtra.CameraTakePicture();
            MainDialog.CloseDialog();
        }
