...
{
    [Activity(Label = "@string/app_name", LaunchMode = Android.Content.PM.LaunchMode.SingleTop, Theme = "@style/AppTheme.Launcher", MainLauncher = true, ScreenOrientation = Android.Content.PM.ScreenOrientation.Portrait)]
    public class SplashActivity : AppCompatActivity
    {
        ...
        private static ImageButton btnReconnect;
        string error;
        int numreconnect = 0;
        ...
        List<string> addlog = new List<string>();
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            try
            {
                ...
                //Set Flag ไม่ให้ notification ทำงาน ตอนที่โหลดขอ้มูลที่หน้า Splash
                DataCashingAll.flagNotificationEnble = true;

                //var appInsightsProvider = new ApplicationInsightsProvider("30fdd00a-0dcb-4dd5-be28-062f8765466b");
                //TinyInsights.Configure(appInsightsProvider);

#if (DEBUG)
                var appInsightsProvider = new ApplicationInsightsProvider("30fdd00a-0dcb-4dd5-be28-062f8765466b", "GabanaAndroidAppLab");
#else
                var appInsightsProvider = new ApplicationInsightsProvider("30fdd00a-0dcb-4dd5-be28-062f8765466b", "GabanaAndroidApp");
#endif
                ...
                //_ = TinyInsightsLib.TinyInsights.TrackEventAsync("SplashActivity", null);
                ...
                Log.Debug("connectpass", "vername" + vername);
                long vernumber = 0;
                ...
                Log.Debug("connectpass", "vernumber" + vernumber);
                ...
                Log.Debug("connectpass", "OnCreate at Splash");
        ...
        protected override void OnResume()
        {
            try
            {
                ...
                if (!main.IsFinishing)
                {
                    Task startupWork = new Task(() => { SimulateStartup(); });
                    startupWork.Start();
                    Log.Debug("connectpass", "OnResume at splash");
                }
                Log.Debug("connectpass", "main.IsFinishing");
            }
            catch (Exception ex)
            {
                _ = TinyInsights.TrackErrorAsync(ex);
                _ = TinyInsights.TrackPageViewAsync("OnResume at Splash");
                Toast.MakeText(this, "OnResume at Splash" + ex.Message, ToastLength.Short).Show();
                base.OnRestart();
            }
        }
        ...
        private async Task ConnectOnline()
        {
            try
            {
                ...
                if (res.status)
                {
                    _ = TinyInsights.TrackEventAsync("ConnectOnline TokenResult  Success : " + DateTime.UtcNow);
                    progressBar.Progress += 5;
                    GabanaAPI.gbnJWT = res.gbnJWT;

                    Log.Debug("connectpass", "GetMerchantDetail Start " + "Time : " + DateTime.Now);
                    addlog.Add("GetMerchantDetail Start " + "Time : " + DateTime.Now);
                    merchants = await GabanaAPI.GetMerchantDetail(DataCashingAll.DevicePlatform, DataCashingAll.DeviceUDID);
                    Log.Debug("connectpass", "GetMerchantDetail End " + "Time : " + DateTime.Now);
                    addlog.Add("GetMerchantDetail End " + "Time : " + DateTime.Now);
                    _ = TinyInsights.TrackEventAsync("GetMerchantDetail : " + DateTime.UtcNow);
                    ...
                    else
                    {
                        ...
                        if (merchants.Merchant != null)
                        {
                            ...
                            {
                                _ = TinyInsights.TrackEventAsync("merchants.Merchant.MerchantID || merchants.Device.DeviceNo = 0 :" + DateTime.UtcNow);
                                StartActivity(new Intent(Application.Context, typeof(LoginActivity)));
                                this.Finish();
                                return;
                            }
                            ...
                            _ = TinyInsights.TrackEventAsync("RegisterBellNotification Success :" + DateTime.UtcNow );
                        ...
                        if (!DataCashing.flagProgress)
                        {
                            ...
                            _ = TinyInsights.TrackEventAsync("Preferences Merchant Success : " + DateTime.UtcNow);
                            ...
                            _ = TinyInsights.TrackEventAsync("Preferences DeviceNo Success : " + DateTime.UtcNow);
                            ...
                            {
                                Log.Debug("connectpass", "CreateDB Start " + "Time : " + DateTime.Now);
                                addlog.Add("CreateDB Start " + "Time : " + DateTime.Now);
                                newMerchant = JsonConvert.DeserializeObject<CreateNewMerchant>(create);
                                Log.Debug("connectpass", "CreateDB End " + "Time : " + DateTime.Now);
                                addlog.Add("CreateDB End " + "Time : " + DateTime.Now);
                                _ = TinyInsights.TrackEventAsync("CreateDB Success : " + DateTime.UtcNow);
                            }
                            ...
                            if (newMerchant.createNew || string.IsNullOrEmpty(create))
                            {
                                ...
                                Log.Debug("connectpass", "CreateMerchnatDB Start  " + "Time : " + DateTime.Now);
                                addlog.Add("CreateMerchnatDB Start" + "Time : " + DateTime.Now);
                                CheckResult = await Utils.CreateMerchnatDB(merchants.Merchant.MerchantID, FileDir);
                                Log.Debug("connectpass", "CreateMerchnatDB End " + "Time : " + DateTime.Now);
                                addlog.Add("CreateMerchnatDB End" + "Time : " + DateTime.Now);
                                _ = TinyInsights.TrackEventAsync("CreateMerchnatDB Success : " + DateTime.UtcNow);
                                if (!CheckResult)
                                {
                                ...
                                Log.Debug("connectpass", "CreatePoolDB Start" + "Time : " + DateTime.Now);
                                addlog.Add("CreatePoolDB Start" + "Time : " + DateTime.Now);
                                CheckResult = await Utils.CreatePoolDB(merchants.Merchant.MerchantID, FileDir);
                                Log.Debug("connectpass", "CreatePoolDB End" + "Time : " + DateTime.Now);
                                addlog.Add("CreatePoolDB End" + "Time : " + DateTime.Now);
                                _ = TinyInsights.TrackEventAsync("CreatePoolDB Success : " + DateTime.UtcNow);
                                if (!CheckResult)
                                {
                                ...
                                //create Folder image
                                Log.Debug("connectpass", "CreateLocalImage Start " + "Time : " + DateTime.Now);
                                addlog.Add("CreateLocalImage Start" + "Time : " + DateTime.Now);
                                CheckResult = await Utils.CreateLocalImage(merchants.Merchant.MerchantID);
                                Log.Debug("connectpass", "CreateLocalImage End " + "Time : " + DateTime.Now);
                                addlog.Add("CreateLocalImage End" + "Time : " + DateTime.Now);
                                _ = TinyInsights.TrackEventAsync("CreateLocalImage Success : " + DateTime.UtcNow);
                                if (!CheckResult)
                                {
                                    ReloadReConnect();
                                    return;
                                }
                                Log.Debug("connectpass", "CreateThumbnailLocalImage Start " + "Time : " + DateTime.Now);
                                addlog.Add("CreateThumbnailLocalImage Start" + "Time : " + DateTime.Now);
                                CheckResult = await Utils.CreateThumbnailLocalImage(merchants.Merchant.MerchantID);
                                Log.Debug("connectpass", "CreateThumbnailLocalImage End " + "Time : " + DateTime.Now);
                                addlog.Add("CreateThumbnailLocalImage End" + "Time : " + DateTime.Now);
                                _ = TinyInsights.TrackEventAsync("CreateThumbnailLocalImage Success : " + DateTime.UtcNow);
                                if (!CheckResult)
                                {
                                    ReloadReConnect();
                                    return;
                                }
                                Log.Debug("connectpass", "CreateDownloadBill Start" + "Time : " + DateTime.Now);
                                addlog.Add("CreateDownloadBill Start" + "Time : " + DateTime.Now);
                                CheckResult = await Utils.CreateDownloadBill(merchants.Merchant.MerchantID);
                                Log.Debug("connectpass", "CreateDownloadBill End " + "Time : " + DateTime.Now);
                                addlog.Add("CreateDownloadBill End" + "Time : " + DateTime.Now);
                                _ = TinyInsights.TrackEventAsync("CreateDownloadBill Success : " + DateTime.UtcNow);
                                if (!CheckResult)
                                {
                                    ReloadReConnect();
                                    return;
                                ...
                                Log.Debug("connectpass", "createNewDB" + "Time : " + DateTime.Now);
                                _ = TinyInsights.TrackEventAsync("createNewDB Success : " + DateTime.UtcNow);
                            ...
                            Log.Debug("connectpass", "UpdateDatabase Start" + "Time : " + DateTime.Now);
                            addlog.Add("UpdateDatabase Start" + "Time : " + DateTime.Now);
                            ...
                            if (datainfo == null)
                            {
                                ...
                                addlog.Add("UpdateDatabase End" + "Time : " + DateTime.Now);
                                addlog.Add("CreatePoolDB Start" + "Time : " + DateTime.Now);
                            ...
                            #endregion
                            Log.Debug("connectpass", "UpdateDatabase End" + "Time : " + DateTime.Now);
                            addlog.Add("UpdateDatabase End" + "Time : " + DateTime.Now);
                            ...
                            Log.Debug("connectpass", "Merchant Start " + "Time : " + DateTime.Now);
                            addlog.Add("Merchant Start " + "Time : " + DateTime.Now);
                            ...
                            {
                                Log.Debug("connectpass", "InsertLocalPictureMerchant Start" + "Time : " + DateTime.Now);
                                addlog.Add("InsertLocalPictureMerchant Start" + "Time : " + DateTime.Now);
                                await Utils.InsertLocalPictureMerchant(GETmerchantlocal);
                                Log.Debug("connectpass", "InsertLocalPictureMerchant End " + "Time : " + DateTime.Now);
                                addlog.Add("InsertLocalPictureMerchant End" + "Time : " + DateTime.Now);
                            }
                            Log.Debug("connectpass", "Merchant End " + "Time : " + DateTime.Now);
                            addlog.Add("Merchant End " + "Time : " + DateTime.Now);
                            ...
                            Log.Debug("connectpass", "branch " + branch);
            ...
            {
                Log.Debug("connectpass", "ConnectOnline ex" + ex.Message);
                _ = TinyInsights.TrackErrorAsync(ex);
        ...
        async Task InsertUserAccount()
        {
            try
            {
                ...
                Log.Debug("connectpass", "GetSeAuthDataListUserAccount Start API " + "Time : " + DateTime.Now);
                addlog.Add("GetSeAuthDataListUserAccount Start API " + "Time : " + DateTime.Now);
                DataCashingAll.UserAccountInfo = await GabanaAPI.GetSeAuthDataListUserAccount();
                Log.Debug("connectpass", "GetSeAuthDataListUserAccount End API " + "Time : " + DateTime.Now);
                addlog.Add("GetSeAuthDataListUserAccount End API " + "Time : " + DateTime.Now);

                Log.Debug("connectpass", "GetDataBranchPolicy Start API" + "Time : " + DateTime.Now);
                addlog.Add("GetDataBranchPolicy Start API" + "Time : " + DateTime.Now);
                getlstbranchPolicy = await GabanaAPI.GetDataBranchPolicy();
                Log.Debug("connectpass", "GetDataBranchPolicy End API" + "Time : " + DateTime.Now);
                addlog.Add("GetDataBranchPolicy End API" + "Time : " + DateTime.Now);

                Log.Debug("connectpass", "DataCashingAll.UserAccountInfo Start Model" + "Time : " + DateTime.Now);
                addlog.Add("DataCashingAll.UserAccountInfo Start Model" + "Time : " + DateTime.Now);
                ...
                Log.Debug("connectpass", "DataCashingAll.UserAccountInfo End Model" + "Time : " + DateTime.Now);
                addlog.Add("DataCashingAll.UserAccountInfo End Model" + "Time : " + DateTime.Now);
            }
            catch (Exception ex)
            {
                _ = TinyInsights.TrackErrorAsync(ex);
        ...
        private async void Connectoffine()
        {
            try
            {
                ...
                if (DataCashingAll.GetGabanaInfo == null)
                {
                    ...
                    if (GabanaInfo != "")
                    {
                        var info = JsonConvert.DeserializeObject<GabanaInfo>(GabanaInfo);
        ...
        public async Task InsertBranchtoLocal()
        {
            try
            {
                ...
                Log.Debug("connectpass", "InsertBranchtoLocal Start " + "Time : " + DateTime.Now);
                addlog.Add("InsertBranchtoLocal Start " + "Time : " + DateTime.Now);
                for (int i = 0; i < merchants.Branch.Count; i++)
                {
                    insertBranch.MerchantID = merchants.Merchant.MerchantID;
                    insertBranch.SysBranchID = int.Parse(merchants.Branch[i].BranchID);
                ...
                Log.Debug("connectpass", "InsertBranchtoLocal End " + "Time : " + DateTime.Now);
                addlog.Add("InsertBranchtoLocal End " + "Time : " + DateTime.Now);
            }
            catch (Exception ex)
            {
                _ = TinyInsights.TrackErrorAsync(ex);
                ...
                foreach (var dataRivision in listRivision)
                {
                    switch (dataRivision.SystemID)
                    {
                        ...
                        case 20:
                            ...
                            {
                                //Get Category API
                                Log.Debug("connectpass", "Category Start API " + "Time : " + DateTime.Now);
                                addlog.Add("Category Start API " + "Time : " + DateTime.Now);
                                var allcategory = await GabanaAPI.GetDataCategory((int)dataRivision.LastRevisionNo);
                                Log.Debug("connectpass", "Category Start API " + "Time : " + DateTime.Now);
                                addlog.Add("Category Start API " + "Time : " + DateTime.Now);

                                Log.Debug("connectpass", "Category Start Model " + "Time : " + DateTime.Now);
                                addlog.Add("Category Start Model " + "Time : " + DateTime.Now);
                                if (allcategory == null)
                                {
                                    break;
                                }
                                ...
                                {
                                    progressBar.Progress += 5;//progressBar 25
                                    break;
                                }
                        ...
                        case 30:
                            ...
                            try
                            {
                                Log.Debug("connectpass", "Item Start API " + "Time : " + DateTime.Now);
                                addlog.Add("Item Start API " + "Time : " + DateTime.Now);
                                var allItem = await GabanaAPI.GetDataItem((int)dataRivision.LastRevisionNo, 0);
                                Log.Debug("connectpass", "Item End API " + "Time : " + DateTime.Now);
                                addlog.Add("Item End API " + "Time : " + DateTime.Now);

                                Log.Debug("connectpass", "Item  Start Model " + "Time : " + DateTime.Now);
                                addlog.Add("Item  Start Model " + "Time : " + DateTime.Now);
                                if (allItem == null)
                                {
                                ...
                                else
                                {
                                    ...
                                    Log.Debug("connectpass", "Item End Model " + "Time : " + DateTime.Now);
                                    addlog.Add("Item End Model " + "Time : " + DateTime.Now);
                        ...
                        case 31:
                            ...
                            try
                            {
                                Log.Debug("connectpass", "ItemOnBranch  Start API " + "Time : " + DateTime.Now);
                                addlog.Add("ItemOnBranch  Start API " + "Time : " + DateTime.Now);
                                var allItemOnBranch = await GabanaAPI.GetDataItemOnBranchV2((int)dataRivision.LastRevisionNo, 0);
                                Log.Debug("connectpass", "ItemOnBranch  End API " + "Time : " + DateTime.Now);
                                addlog.Add("ItemOnBranch  End API " + "Time : " + DateTime.Now);

                                Log.Debug("connectpass", "ItemOnBranch  Start Model " + "Time : " + DateTime.Now);
                                addlog.Add("ItemOnBranch  Start Model " + "Time : " + DateTime.Now);
                                if (allItemOnBranch == null)
                                {
                                    progressBar.Progress += 20;
                                    break;
                                ...
                                Log.Debug("connectpass", "ItemOnBranch End Model " + "Time : " + DateTime.Now);
                                addlog.Add("ItemOnBranch End Model " + "Time : " + DateTime.Now);
                            }
                            catch (Exception ex)
                            {
                        ...
                        case 50:
                            ...
                            {
                                //Get Customer API
                                Log.Debug("connectpass", "Customer Start API " + "Time : " + DateTime.Now);
                                addlog.Add("Customer Start API " + "Time : " + DateTime.Now);
                                var allcustomer = await GabanaAPI.GetDataCustomer((int)dataRivision.LastRevisionNo, 0);
                                Log.Debug("connectpass", "Customer End API " + "Time : " + DateTime.Now);
                                addlog.Add("Customer End API " + "Time : " + DateTime.Now);

                                Log.Debug("connectpass", "Customer Start Model " + "Time : " + DateTime.Now);
                                addlog.Add("Customer Start Model " + "Time : " + DateTime.Now);
                                if (allcustomer == null)
                                {
                                    progressBar.Progress += 5;
                                    break;
                                ...
                                Log.Debug("connectpass", "Customer End Model " + "Time : " + DateTime.Now);
                                addlog.Add("Customer End Model " + "Time : " + DateTime.Now);
                            ...
                            catch (Exception ex)
                            {
                                ...
                                _ = TinyInsights.TrackErrorAsync(ex);
                                _ = TinyInsights.TrackPageViewAsync("connecterror Customer");
                            }
                            #endregion   
                            break;
                        case 60:
                            ...
                            try
                            {
                                Log.Debug("connectpass", "NoteCategory Start API " + "Time : " + DateTime.Now);
                                addlog.Add("NoteCategory Start API " + "Time : " + DateTime.Now);
                                var allNoteCategory = await GabanaAPI.GetDataNoteCategory((int)dataRivision.LastRevisionNo);
                                Log.Debug("connectpass", "NoteCategory End API " + "Time : " + DateTime.Now);
                                addlog.Add("NoteCategory End API " + "Time : " + DateTime.Now);

                                Log.Debug("connectpass", "NoteCategory Start Model " + "Time : " + DateTime.Now);
                                addlog.Add("NoteCategory Start Model " + "Time : " + DateTime.Now);
                                ...
                                Log.Debug("connectpass", "NoteCategory End Model " + "Time : " + DateTime.Now);
                                addlog.Add("NoteCategory End Model " + "Time : " + DateTime.Now);
                                progressBar.Progress += 5;//progressBar 95
                            ...
                            catch (Exception ex)
                            {
                                ...
                                _ = TinyInsights.TrackErrorAsync(ex);
                                _ = TinyInsights.TrackPageViewAsync("connecterror NoteCategory");
                            }
                            #endregion
                            break;
                        case 70:
                            ...
                            try
                            {
                                ...
                                Log.Debug("connectpass", "Note Start API " + "Time : " + DateTime.Now);
                                addlog.Add("Note Start API " + "Time : " + DateTime.Now);
                                var allNote = await GabanaAPI.GetDataNotes((int)dataRivision.LastRevisionNo, 0);
                                Log.Debug("connectpass", "Note End  API " + "Time : " + DateTime.Now);
                                addlog.Add("Note End  API " + "Time : " + DateTime.Now);

                                Log.Debug("connectpass", "Note Start Model " + "Time : " + DateTime.Now);
                                addlog.Add("Note Start Model " + "Time : " + DateTime.Now);
                                if (allNote == null)
                                {
                                ...
                                Log.Debug("connectpass", "Note End Model " + "Time : " + DateTime.Now);
                                addlog.Add("Note End Model " + "Time : " + DateTime.Now);
                                progressBar.Progress += 5;
                            ...
                            catch (Exception ex)
                            {
                                ...
                                _ = TinyInsights.TrackErrorAsync(ex);
                                _ = TinyInsights.TrackPageViewAsync("connecterror Note");
                            }
                            #endregion                            
                            break;
                        default:
        ...
        async Task GetmerchantConfig()
        {
            try
            {
                ...
                Log.Debug("connectpass", "GetmerchantConfig Start API " + "Time : " + DateTime.Now);
                addlog.Add("GetmerchantConfig Start API " + "Time : " + DateTime.Now);
                listmerchantConfig = await GabanaAPI.GetDataMerchantConfig();
                Log.Debug("connectpass", "GetmerchantConfig End API " + "Time : " + DateTime.Now);
                addlog.Add("GetmerchantConfig End API " + "Time : " + DateTime.Now);

                Log.Debug("connectpass", "GetmerchantConfig Start Model " + "Time : " + DateTime.Now);
                addlog.Add("GetmerchantConfig Start Model " + "Time : " + DateTime.Now);
                ...
                Log.Debug("connectpass", "GetmerchantConfig End Model " + "Time : " + DateTime.Now);
                addlog.Add("GetmerchantConfig End Model " + "Time : " + DateTime.Now);
            }
            catch (Exception ex)
            {
                Log.Debug("connectpass", "listmerchantConfig ex" + ex.Message);
                _ = TinyInsights.TrackErrorAsync(ex);
        ...
        async Task GetMemberTypeData()
        {
            try
            {
                ...
                Log.Debug("connectpass", "GetMemberTypeData Start API " + "Time : " + DateTime.Now);
                addlog.Add("GetMemberTypeData Start API " + "Time : " + DateTime.Now);
                listmembertype = await GabanaAPI.GetDataMemberType();
                Log.Debug("connectpass", "GetMemberTypeData Start API " + "Time : " + DateTime.Now);
                addlog.Add("GetMemberTypeData Start API " + "Time : " + DateTime.Now);

                Log.Debug("connectpass", "GetMemberTypeData Start Model " + "Time : " + DateTime.Now);
                addlog.Add("GetMemberTypeData Start Model " + "Time : " + DateTime.Now);
        ...
        async Task GetDeviceData()
        {
            try
            {
                ...
                Log.Debug("connectpass", "GetDeviceData Start API " + "Time : " + DateTime.Now);
                addlog.Add("GetDeviceData Start API " + "Time : " + DateTime.Now);
                Device = await GabanaAPI.GetDataDevice(DataCashingAll.DeviceUDID, DataCashingAll.DevicePlatform);
                Log.Debug("connectpass", "GetDeviceData End API " + "Time : " + DateTime.Now);
                addlog.Add("GetDeviceData End API " + "Time : " + DateTime.Now);

                Log.Debug("connectpass", "GetDeviceData Stat Model " + "Time : " + DateTime.Now);
                addlog.Add("GetDeviceData Stat Model " + "Time : " + DateTime.Now);
                ...
                Log.Debug("connectpass", "GetDeviceData End Model" + "Time : " + DateTime.Now);
                addlog.Add("GetDeviceData End Model" + "Time : " + DateTime.Now);
            }
            catch (Exception ex)
            {
                _ = TinyInsights.TrackErrorAsync(ex);
        ...
        async Task GetGiftVoucher()
        {
            ...
            {                
                ...
                Log.Debug("connectpass", "GetGiftVoucher Start API " + "Time : " + DateTime.Now);
                addlog.Add("GetGiftVoucher Start API " + "Time : " + DateTime.Now);
                listgiftVouchers = await GabanaAPI.GetDataGiftVoucher();
                Log.Debug("connectpass", "GetGiftVoucher End API " + "Time : " + DateTime.Now);
                addlog.Add("GetGiftVoucher End API " + "Time : " + DateTime.Now);

                Log.Debug("connectpass", "GetGiftVoucher Start Model " + "Time : " + DateTime.Now);
                addlog.Add("GetGiftVoucher Start Model " + "Time : " + DateTime.Now);
                ...
                Log.Debug("connectpass", "GetGiftVoucher End Model " + "Time : " + DateTime.Now);
                addlog.Add("GetGiftVoucher End Model " + "Time : " + DateTime.Now);
            }
            catch (Exception ex)
            {
                _ = TinyInsights.TrackErrorAsync(ex);
        ...
        async Task GetMyQRCode()
        {
            try
            {
                ...
                Log.Debug("connectpass", "GetMyQRCode Start API " + "Time : " + DateTime.Now);
                addlog.Add("GetMyQRCode Start API " + "Time : " + DateTime.Now);
                myqrcodes = await GabanaAPI.GetDataMyQrCode();
                Log.Debug("connectpass", "GetMyQRCode End API " + "Time : " + DateTime.Now);
                addlog.Add("GetMyQRCode End API " + "Time : " + DateTime.Now);

                Log.Debug("connectpass", "GetMyQRCode Start Model " + "Time : " + DateTime.Now);
                addlog.Add("GetMyQRCode Start Model " + "Time : " + DateTime.Now);
                if (myqrcodes == null)
                {
                    return;
                }
                ...
                Log.Debug("connectpass", "GetMyQRCode End Model " + "Time : " + DateTime.Now);
                addlog.Add("GetMyQRCode End Model " + "Time : " + DateTime.Now);
            }
            catch (Exception ex)
            {
                _ = TinyInsights.TrackErrorAsync(ex);
        ...
        async Task SetDataDeviceTranRunningNo()
        {
            try
            {
                ...
                deviceTranRunningNoManage = new DeviceTranRunningNoManage();
                List<DeviceTranRunningNo> lstTranRunnning = new List<DeviceTranRunningNo>();
                lstTranRunnning = await deviceTranRunningNoManage.GetAllDeviceTranRunningNo(DataCashingAll.MerchantId);

                if (lstTranRunnning.Count == 0)
                {
                ...
                {
                    lstTranRunnning = await deviceTranRunningNoManage.GetAllDeviceTranRunningNo(DataCashingAll.MerchantId);
                    lstTranRunnning = lstTranRunnning.Where(x => x.MerchantID == DataCashingAll.MerchantId & x.SysBranchID == DataCashingAll.SysBranchId).ToList();
                    if (lstTranRunnning.Count == 0)
                    {
                        deviceTranRunning = new DeviceTranRunningNo()
                        {
        ...
        async Task GetCashTemplate()
        {
            try
            {
                ...
                Log.Debug("connectpass", "GetCashTemplate Start Model " + "Time : " + DateTime.Now);
                addlog.Add("GetCashTemplate Start Model " + "Time : " + DateTime.Now);
                listcashTemplate = await GabanaAPI.GetDataCashTemplate();
                Log.Debug("connectpass", "GetCashTemplate End Model " + "Time : " + DateTime.Now);
                addlog.Add("GetCashTemplate End Model " + "Time : " + DateTime.Now);
