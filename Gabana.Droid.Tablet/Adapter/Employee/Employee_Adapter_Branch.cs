...
{
    internal class Employee_Adapter_Branch : RecyclerView.Adapter
    {
        ...
        public Employee_Adapter_Branch(ListBranch l)
        {
            listitem = l;
        }
        ...
        public override void OnBindViewHolder(RecyclerView.ViewHolder holder, int position)
        {
            ...
            var index = Employee_Dialog_SelectBranch.listChooseBranch.FindIndex(x => x.SysBranchID == listitem[position].SysBranchID);
            if (index == -1)
            {
        ...
        {
            View itemView = LayoutInflater.From(parent.Context).Inflate(Resource.Layout.employee_adapter_selectbranch, parent, false);
