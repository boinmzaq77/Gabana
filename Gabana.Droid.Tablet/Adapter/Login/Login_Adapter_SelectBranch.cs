...
{
    public class Login_Adapter_SelectBranch : RecyclerView.Adapter
    {
        ...
        public Login_Adapter_SelectBranch(ListBranch l)
        {
            listitem = l;
        }
        ...
        public override void OnBindViewHolder(RecyclerView.ViewHolder holder, int position)
        {
            ...
            if (listitem[position].BranchID == SelectBranchActivity.branchSelect)
            {
