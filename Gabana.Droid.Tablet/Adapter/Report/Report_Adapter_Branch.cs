...
{
    public class Report_Adapter_Branch : RecyclerView.Adapter
    {
        ...
        public Report_Adapter_Branch(List<SaleReportBranch> l)
        {
            listSaleByBranch = l;
        }
        ...
        {
            View itemView = LayoutInflater.From(parent.Context).Inflate(Resource.Layout.report_adapter_showbranch, parent, false);
