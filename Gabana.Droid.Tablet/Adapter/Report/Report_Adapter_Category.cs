...
{
    internal class Report_Adapter_Category : RecyclerView.Adapter
    {
        ...
        {
            View itemView = LayoutInflater.From(parent.Context).Inflate(Resource.Layout.report_adapter_category, parent, false);
