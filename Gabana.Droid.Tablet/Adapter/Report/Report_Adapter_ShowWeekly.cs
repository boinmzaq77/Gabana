...
{
    internal class Report_Adapter_ShowWeekly : RecyclerView.Adapter
    {

        public event EventHandler<int> ItemClick;
        public List<ReportWeekly> listTime;
        public string positionClick;


        public Report_Adapter_ShowWeekly(List<ReportWeekly> l)
        {
            listTime = l;
        }
        ...
        public override void OnBindViewHolder(RecyclerView.ViewHolder holder, int position)
        {
            ...
            vh.Time.Text = listTime[position].Weeklyname;
