...
{
    public class AddItem_Dialog_SelectMedia : AndroidX.Fragment.App.DialogFragment
    {
        ...
        public static AddItem_Dialog_SelectMedia NewInstance()
        {
            var frag = new AddItem_Dialog_SelectMedia { Arguments = new Bundle() };
            return frag;
        }
