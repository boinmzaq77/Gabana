...
{
    public class Edit_Dialog_Back : AndroidX.Fragment.App.DialogFragment
    {
        ...
        public static Edit_Dialog_Back NewInstance()
        {
        ...
        private void Btn_save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Page == "merchant")
                {
                    Setting_Fragment_Merchant.fragment_main.btnSave.PerformClick();
                }
                if (Page == "device")
                {
                    Setting_Fragment_Device.fragment_device.btnSave.PerformClick();
                }
                if (Page == "cashdrawer")
                {
                    Setting_Fragment_CashDrawer.fragment_device.btnSave.PerformClick();
                }
                Dismiss();
            }
            catch (Exception ex)
        ...
        private void Btn_cancel_Click(object sender, EventArgs e)
        {
            ...
            if (Page == "merchant")
            {
                Setting_Fragment_Merchant.fragment_main.SetClearData();
            }
            if (Page == "branch")
            {
            ...
            if (Page == "device")
            {
                Setting_Fragment_Device.fragment_device.SetClearData();
            }
            if (Page == "merchant")
            {
                Setting_Fragment_Merchant.fragment_main.SetClearData();
            ...
            if (Page == "cashdrawer")
            {
                Setting_Fragment_CashDrawer.fragment_device.SetClearData();
            }
            Dismiss();
        }
