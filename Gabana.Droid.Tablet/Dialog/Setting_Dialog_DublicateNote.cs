...
{
    public class Setting_Dialog_DublicateNote : AndroidX.Fragment.App.DialogFragment
    {
        ...
        public static Setting_Dialog_DublicateNote NewInstance()
        {

            var frag = new Setting_Dialog_DublicateNote { Arguments = new Bundle() };
            return frag;
        }
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            try
            {
                ...
                var textItemName = Setting_Fragment_AddNote.fragment_addnote.textNote.Text ;
