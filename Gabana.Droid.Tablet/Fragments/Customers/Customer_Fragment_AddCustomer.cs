...
{
    public class Customer_Fragment_AddCustomer : AndroidX.Fragment.App.Fragment
    {
        View view;
        public static Customer_Fragment_AddCustomer fragment_main;

        public override void OnCreate(Bundle savedInstanceState)
        {
            base.OnCreate(savedInstanceState);
        }
        public static Customer_Fragment_AddCustomer NewInstance()
        {
            Customer_Fragment_AddCustomer frag = new Customer_Fragment_AddCustomer();
            return frag;
        }
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            {
                _ = TinyInsights.TrackPageViewAsync("OnCreate at AddCustomer");
