...
{
    public class Payment_Fragment_Credit : AndroidX.Fragment.App.Fragment
    {
        ...
        public static Payment_Fragment_Credit NewInstance()
        {
            Payment_Fragment_Credit frag = new Payment_Fragment_Credit();
            return frag;
        }
        View view;
        public static TranWithDetailsLocal tranWithDetails;
        public static Payment_Fragment_Credit fragment_credit;

        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            view = inflater.Inflate(Resource.Layout.payment_fragment_credit, container, false);
            try
            {
                fragment_credit = this;
