...
namespace Gabana.POS
{
    ...
    public partial class SeniorContactController : UIViewController
    {
        ...
        void initAttribute()
        {
            ...
            TelImg.Image = UIImage.FromBundle("ContactTel");
            ...
            EmailImg.Image = UIImage.FromBundle("ContactMail");
            ...
            lblEmail.Text = "info@seniorsoft.co.th";
            ...
            LineImg.Image = UIImage.FromBundle("ContactLine");
            ...
            FacebookImg.Image = UIImage.FromBundle("ContactFb");
            ...
            WebImg.Image = UIImage.FromBundle("ContactSns");
            ...
            lblWeb.Text = "www.seniorsoft.co.th";
            ...
            LocationImg.Image = UIImage.FromBundle("ContactAddress");
        ...
        public void Email(UIGestureRecognizer sender)
        {
            try
            {
                UIApplication.SharedApplication.OpenUrl(new NSUrl("https://mail.google.com/mail/u/0/?view=cm&fs=1&tf=1&source=mailto&to=" + "info@seniorsoft.co.th"));
            }
            catch (Exception ex)
            {
                _ = TinyInsights.TrackErrorAsync(ex);
        ...
        public async void location(UIGestureRecognizer sender)
        {
            try
            {
                UIApplication.SharedApplication.OpenUrl(new NSUrl("https://goo.gl/maps/FHD2eVLt8BHcjFqy5") );
        ...
        public void Line(UIGestureRecognizer sender)
        {
            try
            {
                UIApplication.SharedApplication.OpenUrl(new NSUrl("https://line.me/R/ti/p/%40698ipxjn"));
            }
            catch (Exception ex)
            {
                _ = TinyInsights.TrackErrorAsync(ex);
