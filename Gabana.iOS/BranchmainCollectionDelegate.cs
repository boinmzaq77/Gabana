...
{
    public class BranchmainCollectionDelegate : UICollectionViewDelegate
    {
        public override bool ShouldSelectItem(UICollectionView collectionView, NSIndexPath indexPath)
        {
            BranchCollectionViewCell cell = collectionView.CellForItem(indexPath) as BranchCollectionViewCell;
            if (cell == null)
            {
