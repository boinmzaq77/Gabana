...
namespace Gabana.iOS
{
    ...
    public partial class DashBoardBranchController : UIViewController
    {
        ...
        public DashBoardBranchController(string page)
        {
            this.page = page; 
        }
        ...
        public async override void ViewDidLoad()
        {
         ...
         //   branch = await setBranch.GetAllBranch((int)MainController.merchantlocal.MerchantID);
            ...
            btnSelect.TouchUpInside += (sender, e) => {
                if (page == "billhistory")
                {
                    BillHistoryController.BranchSelect.BranchName = choosebranch[Select].BranchName;
                    BillHistoryController.BranchSelect.SysBranchID = choosebranch[Select].SysBranchID;
                    BillHistoryController.isModifyBranch = true;
                }
                else
                {
        ...
        private async void GetListBranchbyMainRole()
        {
            ...
            DashboardChooseBranchDataSource BranchDataList = new DashboardChooseBranchDataSource(choosebranch);
            //ChangeBranchDatasource BranchDataList = new ChangeBranchDatasource(lstBranc);
            branchCollectionView.DataSource = BranchDataList;
            branchCollectionView.ReloadData();
        }
