...
{
    public class DashBoardChooseBranchCollectionDelegate : UICollectionViewDelegate
    {
        public override bool ShouldSelectItem(UICollectionView collectionView, NSIndexPath indexPath)
        {
            DashboardChooseBranchViewCell cell = collectionView.CellForItem(indexPath) as DashboardChooseBranchViewCell;
            if (cell == null)
            {
