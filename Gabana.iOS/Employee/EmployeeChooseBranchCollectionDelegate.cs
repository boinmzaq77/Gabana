...
{
    public class EmployeeChooseBranchCollectionDelegate : UICollectionViewDelegate
    {
        public override bool ShouldSelectItem(UICollectionView collectionView, NSIndexPath indexPath)
        {
            EmployeeChooseBranchViewCell cell = collectionView.CellForItem(indexPath) as EmployeeChooseBranchViewCell;
            if (cell == null)
            {
