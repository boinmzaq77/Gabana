...
{
    public class CellItemStockList : UICollectionViewCell
    {
        ...
        public CellItemStockList(IntPtr handle) : base(handle)
        {
            viewall = new UIView();
        ...
        private void setupListView()
        {
            ...
            lblCategory.TopAnchor.ConstraintEqualTo(lblname.SafeAreaLayoutGuide.BottomAnchor, 1).Active = true;
        ...
        public int Stock
        {
            ...
            set
            {
                ...
                {
                    lblCost.TextColor = UIColor.FromRGB(248, 151, 29);
                ...
                else // under stock min
                {
                    ...
                    lblCost.TextColor = UIColor.FromRGB(227, 45, 73);
                    StockImg.Hidden = false;
        ...
        public delegate void itemSelectedDelegate(CellItemStockList indexPath);
        public event itemSelectedDelegate OnItemSwipe;

        public delegate void itemdeleteDelegate(CellItemStockList indexPath);
        public event itemdeleteDelegate OnDeleteItem;

        public delegate void itemFavDelegate(CellItemStockList indexPath);
