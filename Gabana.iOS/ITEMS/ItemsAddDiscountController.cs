...
namespace Gabana.iOS.ITEMS
{
    public partial class ItemsAddDiscountController : UIViewController
    {
        ...
        UIView DiscountNameView, DiscountTypeView, AmountView, BottomView1, emptyView, BottomView2;
        ...
        public override void ViewDidLoad()
        {
            ...
            btnSelectType.SetBackgroundImage(UIImage.FromBundle("DetailNotShow"),UIControlState.Normal);
            ...
            btnSelectType.TouchUpInside += (sender, e) => {
                ...
                DiscountTypeMenuSheet.AddAction(UIAlertAction.Create("Cancel", UIAlertActionStyle.Cancel, Action => Console.WriteLine("Cancel clicked")));
        ...
        void SetupAutoLayout()
        {
            ...
            lblDiscountName.TopAnchor.ConstraintEqualTo(DiscountNameView.SafeAreaLayoutGuide.TopAnchor, 11).Active = true;
            ...
            lblDiscountType.TopAnchor.ConstraintEqualTo(DiscountTypeView.SafeAreaLayoutGuide.TopAnchor, 11).Active = true;
            ...
            btnSelectType.TopAnchor.ConstraintEqualTo(DiscountTypeView.SafeAreaLayoutGuide.TopAnchor, 11).Active = true;
            btnSelectType.WidthAnchor.ConstraintEqualTo(18).Active = true;
            btnSelectType.RightAnchor.ConstraintEqualTo(DiscountTypeView.SafeAreaLayoutGuide.RightAnchor, -15).Active = true;
            btnSelectType.HeightAnchor.ConstraintEqualTo(18).Active = true;
            #endregion
            ...
            lblAmount.TopAnchor.ConstraintEqualTo(AmountView.SafeAreaLayoutGuide.TopAnchor, 11).Active = true;
