...
namespace Plugin.InAppBilling
{
	...
	{
        readonly TaskCompletionSource<IEnumerable<SKProduct>> tcsResponse = new TaskCompletionSource<IEnumerable<SKProduct>>();
	...
	class PaymentObserver : SKPaymentTransactionObserver
	{
		...
		readonly List<SKPaymentTransaction> restoredTransactions = new List<SKPaymentTransaction>();
