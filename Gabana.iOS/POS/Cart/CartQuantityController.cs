...
{
    public partial class CartQuantityController : UIViewController
    {
        UIView quantityView, bottomView, numpadView,emptyView;
        UILabel  lblQuantity;
        string setQuantity;
        int count;
        Model.TranDetailItemNew item;
        ...
        public CartQuantityController(Model.TranDetailItemNew item)
        {
            this.item = item;
        ...
        public override void ViewWillAppear(bool animated)
        {
            ...
            this.lblQuantity.Text = count.ToString();
            setQuantity = count.ToString();
        ...
        public override void ViewDidLoad()
        {
            ...
            btnAddQuantity.SetTitle(Utils.TextBundle("done", "Items"), UIControlState.Normal);
            ...
            btnAddQuantity.TouchUpInside += (sender, e) => {
                ...
                if (Convert.ToInt32(lblQuantity.Text) > 0 && lblQuantity.Text.Length > 0)
                {
                    ...
                    POSController.tranWithDetails = BLTrans.ChangeQuantity(POSController.tranWithDetails, item, Int32.Parse(lblQuantity.Text));
        ...
        void SetupAutoLayout()
        {
            ...
            lblQuantity.WidthAnchor.ConstraintEqualTo(220).Active = true;
