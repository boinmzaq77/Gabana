...
{
    public class CashguideCashCollectionViewCell : UICollectionViewCell
    {
        UILabel lblmenu;
        public CashguideCashCollectionViewCell(IntPtr handle) : base(handle)
        {
                lblmenu = new UILabel() { TranslatesAutoresizingMaskIntoConstraints = false };
                lblmenu.TextColor = UIColor.FromRGB(0, 149, 218);
                lblmenu.Font = lblmenu.Font.WithSize(11);
