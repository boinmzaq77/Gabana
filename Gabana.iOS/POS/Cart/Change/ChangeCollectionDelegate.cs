...
{
    public class ChangeCollectionDelegate : UICollectionViewDelegate
    {
        public override bool ShouldSelectItem(UICollectionView collectionView, NSIndexPath indexPath)
        {
            ChangeCollectionViewCell cell = collectionView.CellForItem(indexPath) as ChangeCollectionViewCell;
            if (cell == null)
            {
