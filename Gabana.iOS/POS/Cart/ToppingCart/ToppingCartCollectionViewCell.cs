...
{
    public class ToppingCartCollectionViewCell : UICollectionViewCell
    {
        UILabel lblText, lblPrice, lblPriceperamount, lblamount , lbldelete;
        public ToppingCartCollectionViewCell(IntPtr handle) : base(handle)
        {
            //ContentView.BackgroundColor = UIColor.Gray;
            lblText = new UILabel() { TranslatesAutoresizingMaskIntoConstraints = false };
            lblText.TextColor = UIColor.FromRGB(112,112, 112);
        ...
        private void setupListView()
        {
            ...
            lblText.LeftAnchor.ConstraintEqualTo(ContentView.LeftAnchor).Active = true;
