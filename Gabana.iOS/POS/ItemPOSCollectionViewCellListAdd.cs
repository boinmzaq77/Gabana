...
{
    public class ItemPOSCollectionViewCellListAdd : UICollectionViewCell
    {
        ...
        public ItemPOSCollectionViewCellListAdd(IntPtr handle) : base(handle)
        {
            ...
            viewall.BackgroundColor = UIColor.FromRGBA(0, 0, 0, 0.16f);
            viewall.Alpha = 1;
            ...
            //imageView.Layer.BorderColor = UIColor.FromRGB(51, 170, 225).CGColor;
        ...
        private void setupListView()
        {
            ...
            imageView.RightAnchor.ConstraintEqualTo(viewall.SafeAreaLayoutGuide.RightAnchor, 0).Active = true;
        ...
        public string Image
        {
            ...
            set
            {
                leftimage = imageView.RightAnchor.ConstraintEqualTo(viewall.SafeAreaLayoutGuide.RightAnchor, 0);
                imageView.ContentMode = UIViewContentMode.ScaleAspectFit;
                leftimage.Active = true;
                if (value == "AddItem")
                {
                    //imageViewimageView.Hidden = false;
                    imageView.ContentMode = UIViewContentMode.ScaleAspectFit;
                    leftimage.Active = true;  
                }
                else
                {
                    ...
                    Utils.SetConstant(imageView.Constraints, NSLayoutAttribute.Width, 65);
                }
