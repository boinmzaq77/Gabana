...
{
    public partial class CategoryReportController : UIViewController
    {
        ...
        ReportSelectCategoryController CatPAge = null;
        CategoryReportDetailController CategoryDetailReport = null;
        ...
        UILabel lbl_CateroryHead;
        UIView CategoryView;
        UILabel lbl_Category,lbl_chooseCategory;
        UIImageView btnSelectCategory;
        ...
        public static bool isModifyCategory = false;
        ...
        List<Category> lsCategoryall = new List<Category>();
        ...
        public override async void ViewWillAppear(bool animated)
        {
            ...
            if (isModifyCategory)
            {
                isModifyCategory = false;
                lbl_chooseCategory.Text = "";
                lsCategory = await category.GetAllCategory();
                if (lsCategory.Count == listChooseCategory.Count)
                {
                    lbl_chooseCategory.Text = Utils.TextBundle("allcategory", "All Category");
                    return;
                }
                else if(listChooseCategory.Count == 0)
                {
                    lbl_chooseCategory.Text = Utils.TextBundle("none", "None");
                    return;
                }
                foreach (var item in listChooseCategory)
                {
                    if (lbl_chooseCategory.Text != "")
                    {
                        lbl_chooseCategory.Text += "," + item.Name;
        ...
        private async void SetDataCategory()
        {
           ...
           lsCategory = await category.GetAllCategory();
            ...
            if (listChooseCategory == null || listChooseCategory.Count == 0)
            {
            ...
            if (lsCategory.Count == listChooseCategory.Count)
            {
                lbl_chooseCategory.Text = Utils.TextBundle("allcategory", "Items");
            }
            else
            {
                lbl_chooseCategory.Text = "";
        ...
        void initAttribute()
        {
            ...
            lbl_filterBranch.Text = Utils.TextBundle("branch", "branch");
            ...
            lbl_Branch.Text = Utils.TextBundle("branch", "branch");
            ...
            lbl_BranchSelect.Text = Utils.TextBundle("today", "today");
            ...
            lbl_filterHead.Text = Utils.TextBundle("filterbydate", "Filter By Date");
            ...
            lbl_Month.Text = Utils.TextBundle("month", "Month");
            ...
            lbl_thisMonth.Text = Utils.TextBundle("month", "Month");
            ...
            lbl_Year.Text = Utils.TextBundle("year", "Year");
            ...
            lbl_thisYear.Text = Utils.TextBundle("year", "Year");
            ...
            lbl_StartDate.Text = Utils.TextBundle("startdate", "Start Date");
            ...
            lbl_EndDate.Text = Utils.TextBundle("enddate", "End Date");
            ...
            lbl_CateroryHead = new UILabel
            {
                TextAlignment = UITextAlignment.Left,
                TextColor = UIColor.FromRGB(247, 86, 0),
                TranslatesAutoresizingMaskIntoConstraints = false
            };
            lbl_CateroryHead.Font = lbl_CateroryHead.Font.WithSize(15);
            lbl_CateroryHead.Text = Utils.TextBundle("filterbycategory", "Filter By Category");
            ...
            lbl_Category = new UILabel
            {
                TextColor = UIColor.FromRGB(64, 64, 64),
                TranslatesAutoresizingMaskIntoConstraints = false
            };
            lbl_Category.Font = lbl_Category.Font.WithSize(15);
            lbl_Category.Text = Utils.TextBundle("category", "Category");
            CategoryView.AddSubview(lbl_Category);

            lbl_chooseCategory = new UILabel
            {
                TextColor = UIColor.FromRGB(162, 162, 162),
                TranslatesAutoresizingMaskIntoConstraints = false
            };
            lbl_chooseCategory.Font = lbl_chooseCategory.Font.WithSize(15);
            lbl_chooseCategory.Text = Utils.TextBundle("allcategory", "ALL Category");
            CategoryView.AddSubview(lbl_chooseCategory);

            btnSelectCategory = new UIImageView();
            btnSelectCategory.Image = UIImage.FromBundle("Next");
            btnSelectCategory.TranslatesAutoresizingMaskIntoConstraints = false;
            CategoryView.AddSubview(btnSelectCategory);

            btnSelectCategory.UserInteractionEnabled = true;
            var tapGestureCategory = new UITapGestureRecognizer(this,
                new ObjCRuntime.Selector("Category_select:"))
            {
                NumberOfTapsRequired = 1 // change number as you want 
            };
            btnSelectCategory.AddGestureRecognizer(tapGestureCategory);
            #endregion
            ...
            _contentView.AddSubview(lbl_CateroryHead);
            ...
            btnViewReport.SetTitle(Utils.TextBundle("viewreport", "View Report"), UIControlState.Normal);
            ...
            btnViewReport.TouchUpInside += (sender, e) => {
                ...
                if(listChooseCategory.Count > 0)
                {
                    ...
                    {
                        var enddate = Utils.ChangeDateTimeReport(now);
                        var startdate = Utils.ChangeDateTimeReport(now);
                    ...
                    CategoryDetailReport = new CategoryReportDetailController(listChooseCategory, txtStartDate.Text +"-"+ txtEndDate.Text, filterType, Start, End, lsCategory.Count, filename);
                    this.NavigationController.PushViewController(CategoryDetailReport, false);
                }
                else
                {
                    Utils.ShowAlert(this, Utils.TextBundle("failed", "Failed !"), Utils.TextBundle("choosecatagory", "กรุณาเลือก Category"));
                }
        ...
        [Export("Category_select:")]
        public void Category_select(UIGestureRecognizer sender)
        {
            //open selectCategory page
            CatPAge = new ReportSelectCategoryController();
            this.NavigationController.PushViewController(CatPAge,false);
        ...
        void SetupAutoLayout()
        {
            ...
            lbl_CateroryHead.TopAnchor.ConstraintEqualTo(BranchView.BottomAnchor, 12).Active = true;
            lbl_CateroryHead.LeftAnchor.ConstraintEqualTo(lbl_CateroryHead.Superview.LeftAnchor, 15).Active = true;
            lbl_CateroryHead.RightAnchor.ConstraintEqualTo(lbl_CateroryHead.Superview.CenterXAnchor, 0).Active = true;
            lbl_CateroryHead.HeightAnchor.ConstraintEqualTo(18).Active = true;

            #region CategoryView
            CategoryView.TopAnchor.ConstraintEqualTo(lbl_CateroryHead.BottomAnchor, 10).Active = true;
            CategoryView.LeftAnchor.ConstraintEqualTo(CategoryView.Superview.LeftAnchor, 10).Active = true;
            CategoryView.RightAnchor.ConstraintEqualTo(CategoryView.Superview.RightAnchor, -10).Active = true;
            CategoryView.HeightAnchor.ConstraintEqualTo(60).Active = true;
            //CategoryView.BottomAnchor.ConstraintEqualTo(CategoryView.Superview.BottomAnchor).Active = true;

            lbl_Category.CenterYAnchor.ConstraintEqualTo(lbl_Category.Superview.CenterYAnchor, -12).Active = true;
            lbl_Category.LeftAnchor.ConstraintEqualTo(lbl_Category.Superview.LeftAnchor, 20).Active = true;
            lbl_Category.RightAnchor.ConstraintEqualTo(lbl_Category.Superview.CenterXAnchor, 0).Active = true;
            lbl_Category.HeightAnchor.ConstraintEqualTo(18).Active = true;

            lbl_chooseCategory.TopAnchor.ConstraintEqualTo(lbl_Category.BottomAnchor, 2).Active = true;
            lbl_chooseCategory.LeftAnchor.ConstraintEqualTo(lbl_chooseCategory.Superview.LeftAnchor, 20).Active = true;
            lbl_chooseCategory.RightAnchor.ConstraintEqualTo(lbl_chooseCategory.Superview.CenterXAnchor, 0).Active = true;
            lbl_chooseCategory.HeightAnchor.ConstraintEqualTo(18).Active = true;

            btnSelectCategory.CenterYAnchor.ConstraintEqualTo(btnSelectCategory.Superview.CenterYAnchor).Active = true;
            btnSelectCategory.WidthAnchor.ConstraintEqualTo(28).Active = true;
            btnSelectCategory.RightAnchor.ConstraintEqualTo(btnSelectCategory.Superview.RightAnchor, -25).Active = true;
            btnSelectCategory.HeightAnchor.ConstraintEqualTo(28).Active = true;

            #endregion

            lbl_filterHead.TopAnchor.ConstraintEqualTo(CategoryView.BottomAnchor, 12).Active = true;
