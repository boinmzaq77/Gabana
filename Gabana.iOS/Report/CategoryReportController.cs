...
namespace Gabana.iOS
{
    public partial class CategoryReportController : UIViewController
    {
        ...
        void initAttribute()
        {
            ...
            lbl_CateroryHead.Text = "Filter By Category";
            ...
            lbl_chooseCategory.Text = "Category";
        ...
        void SetupAutoLayout()
        {
          ...
          //  DateView.BottomAnchor.ConstraintEqualTo(DateView.Superview.BottomAnchor).Active = true;
            ...
            lbl_CateroryHead.TopAnchor.ConstraintEqualTo(DateView.BottomAnchor, 12).Active = true;
