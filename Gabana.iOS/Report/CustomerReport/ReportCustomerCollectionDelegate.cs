...
{
    public class ReportCustomerCollectionDelegate : UICollectionViewDelegate
    {
        public override bool ShouldSelectItem(UICollectionView collectionView, NSIndexPath indexPath)
        {
            ReportChooseCustomerViewCell cell = collectionView.CellForItem(indexPath) as ReportChooseCustomerViewCell;
            if (cell == null)
            {
