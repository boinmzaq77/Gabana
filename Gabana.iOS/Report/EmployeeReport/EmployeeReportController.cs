...
{
    public partial class EmployeeReportController : UIViewController
    {
        ...
        ReportSelectEmployeeController EmpPAge = null;
        EmployeeReportDetailController EmpDetailReport = null;

        UIDatePicker datePickerStartView, datePickerEndView;
        //------------------------------------------

        UILabel lbl_EmployeeHead;
        UIView EmployeeView;
        UILabel lbl_Employee,lbl_chooseEmployee;
        UIImageView btnSelectEmployee;
        ...
        public static bool isModifyEmployee = false;
        UserAccountInfoManage Employee = new UserAccountInfoManage();

        internal static List<ORM.MerchantDB.UserAccountInfo> listChooseEmployee = new List<ORM.MerchantDB.UserAccountInfo>();

        List<ORM.MerchantDB.UserAccountInfo> lsEmployee;
        ...
        public override async void ViewWillAppear(bool animated)
        {
            ...
            try
            {
                ...
                Utils.SetTitle(this.NavigationController, Utils.TextBundle("salebyemployee_report", "All branch"));
                this.NavigationController.SetNavigationBarHidden(false, false);
            
                if (isModifyEmployee)
                {
                    isModifyEmployee = false;
                    lbl_chooseEmployee.Text = "";
                    SetDataEmployee();
                }
                string namebranch = "";
        ...
        private async void SetDataEmployee()
        {
           ...
           lsEmployee = await Employee.GetAllUserAccount();

            if (listChooseEmployee == null || listChooseEmployee.Count == 0)
            {
                listChooseEmployee = lsEmployee;
            }

            if (lsEmployee.Count == listChooseEmployee.Count)
            {
                lbl_chooseEmployee.Text = Utils.TextBundle("allemployee", "All branch");
                return;
            }
            else if (listChooseEmployee.Count == 0)
            {
                lbl_chooseEmployee.Text = Utils.TextBundle("none", "All branch");
                return;
            }
            foreach (var item in listChooseEmployee)
            {
                if (lbl_chooseEmployee.Text != "")
                {
                    lbl_chooseEmployee.Text += "," + item.UserName;
        ...
        void initAttribute()
        {
            try
            {
                ...
                lbl_filterBranch.Text = Utils.TextBundle("branch", "All branch");
                ...
                lbl_Branch.Text = Utils.TextBundle("branch", "All branch");
                ...
                lbl_BranchSelect.Text = Utils.TextBundle("today", "All branch");
                ...
                lbl_filterHead.Text = Utils.TextBundle("filterbydate", "All branch");
                ...
                lbl_today.Text = Utils.TextBundle("today", "All branch");
                ...
                lbl_todayDate.Text = Utils.TextBundle("today", "All branch");
                ...
                lbl_Month.Text = Utils.TextBundle("month", "All branch");
                ...
                lbl_thisMonth.Text = Utils.TextBundle("month", "All branch");
                ...
                lbl_Year.Text = Utils.TextBundle("year", "All branch");
                ...
                lbl_thisYear.Text = Utils.TextBundle("year", "All branch");
                ...
                lbl_DateHead.Text = Utils.TextBundle("customizedate", "All branch");
                ...
                lbl_StartDate.Text = Utils.TextBundle("startdate", "All branch");
                ...
                lbl_EndDate.Text = Utils.TextBundle("enddate", "All branch");
                ...
                lbl_EmployeeHead = new UILabel
                {
                    TextAlignment = UITextAlignment.Left,
                    TextColor = UIColor.FromRGB(247, 86, 0),
                    TranslatesAutoresizingMaskIntoConstraints = false
                };
                lbl_EmployeeHead.Font = lbl_EmployeeHead.Font.WithSize(15);
                lbl_EmployeeHead.Text = Utils.TextBundle("filterbyemployee", "All branch");
                ...
                lbl_Employee = new UILabel
                {
                    TextColor = UIColor.FromRGB(64, 64, 64),
                    TranslatesAutoresizingMaskIntoConstraints = false
                };
                lbl_Employee.Font = lbl_Employee.Font.WithSize(15);
                lbl_Employee.Text = Utils.TextBundle("employee", "All branch");
                EmployeeView.AddSubview(lbl_Employee);

                lbl_chooseEmployee = new UILabel
                {
                    TextColor = UIColor.FromRGB(162, 162, 162),
                    TranslatesAutoresizingMaskIntoConstraints = false
                };
                lbl_chooseEmployee.Font = lbl_chooseEmployee.Font.WithSize(15);
                lbl_chooseEmployee.Text = Utils.TextBundle("allemployee", "All branch");
                EmployeeView.AddSubview(lbl_chooseEmployee);

                btnSelectEmployee = new UIImageView();
                btnSelectEmployee.Image = UIImage.FromBundle("Next");
                btnSelectEmployee.TranslatesAutoresizingMaskIntoConstraints = false;
                EmployeeView.AddSubview(btnSelectEmployee);

                btnSelectEmployee.UserInteractionEnabled = true;
                var tapGestureCustomer = new UITapGestureRecognizer(this,
                    new ObjCRuntime.Selector("Customer_select:"))
                {
                    NumberOfTapsRequired = 1 // change number as you want 
                };
                btnSelectEmployee.AddGestureRecognizer(tapGestureCustomer);
                #endregion
                ...
                _contentView.AddSubview(lbl_EmployeeHead);
                _contentView.AddSubview(filterView);
                _contentView.AddSubview(DateView);
                _contentView.AddSubview(EmployeeView);
                ...
                btnViewReport.SetTitle(Utils.TextBundle("viewreport", "All branch"), UIControlState.Normal);
                ...
                btnViewReport.TouchUpInside += (sender, e) => {
                    ...
                    if(listChooseEmployee.Count > 0)
                    {
                        ...
                        EmpDetailReport = new EmployeeReportDetailController(listChooseEmployee, txtStartDate.Text +"-"+ txtEndDate.Text, filterType, Start, End, lsEmployee.Count ,  filename);
                        this.NavigationController.PushViewController(EmpDetailReport, false);
                    }
                    else
                    {
                        Utils.ShowAlert(this, Utils.TextBundle("failed", "Failed !"), Utils.TextBundle("choosecustomer", "All branch"));
                    }
        ...
        public void Customer_select(UIGestureRecognizer sender)
        {
            //open selectCategory page
            EmpPAge = new ReportSelectEmployeeController();
        ...
        void SetupAutoLayout()
        {
            ...
            //UIScrollView can be any size 
                ...
                lbl_EmployeeHead.TopAnchor.ConstraintEqualTo(BranchView.BottomAnchor, 12).Active = true;
                lbl_EmployeeHead.LeftAnchor.ConstraintEqualTo(lbl_EmployeeHead.Superview.LeftAnchor, 15).Active = true;
                lbl_EmployeeHead.RightAnchor.ConstraintEqualTo(lbl_EmployeeHead.Superview.CenterXAnchor, 0).Active = true;
                lbl_EmployeeHead.HeightAnchor.ConstraintEqualTo(18).Active = true;

               
                EmployeeView.TopAnchor.ConstraintEqualTo(lbl_EmployeeHead.BottomAnchor, 10).Active = true;
                EmployeeView.LeftAnchor.ConstraintEqualTo(EmployeeView.Superview.LeftAnchor, 10).Active = true;
                EmployeeView.RightAnchor.ConstraintEqualTo(EmployeeView.Superview.RightAnchor, -10).Active = true;
                EmployeeView.HeightAnchor.ConstraintEqualTo(60).Active = true;
               

                lbl_Employee.CenterYAnchor.ConstraintEqualTo(lbl_Employee.Superview.CenterYAnchor, -12).Active = true;
                lbl_Employee.LeftAnchor.ConstraintEqualTo(lbl_Employee.Superview.LeftAnchor, 20).Active = true;
                lbl_Employee.RightAnchor.ConstraintEqualTo(lbl_Employee.Superview.CenterXAnchor, 0).Active = true;
                lbl_Employee.HeightAnchor.ConstraintEqualTo(18).Active = true;

                lbl_chooseEmployee.TopAnchor.ConstraintEqualTo(lbl_Employee.BottomAnchor, 2).Active = true;
                lbl_chooseEmployee.LeftAnchor.ConstraintEqualTo(lbl_chooseEmployee.Superview.LeftAnchor, 20).Active = true;
                lbl_chooseEmployee.RightAnchor.ConstraintEqualTo(lbl_chooseEmployee.Superview.CenterXAnchor, 0).Active = true;
                lbl_chooseEmployee.HeightAnchor.ConstraintEqualTo(18).Active = true;

                btnSelectEmployee.CenterYAnchor.ConstraintEqualTo(btnSelectEmployee.Superview.CenterYAnchor).Active = true;
                btnSelectEmployee.WidthAnchor.ConstraintEqualTo(28).Active = true;
                btnSelectEmployee.RightAnchor.ConstraintEqualTo(btnSelectEmployee.Superview.RightAnchor, -25).Active = true;
                btnSelectEmployee.HeightAnchor.ConstraintEqualTo(28).Active = true;


                lbl_filterHead.TopAnchor.ConstraintEqualTo(EmployeeView.BottomAnchor, 12).Active = true;
                ...
                //EndDateView.BottomAnchor.ConstraintEqualTo(EndDateView.Superview.BottomAnchor).Active = true;
