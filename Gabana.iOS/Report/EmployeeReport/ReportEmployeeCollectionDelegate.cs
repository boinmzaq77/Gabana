...
{
    public class ReportEmployeeCollectionDelegate : UICollectionViewDelegate
    {
        public override bool ShouldSelectItem(UICollectionView collectionView, NSIndexPath indexPath)
        {
            ReportChooseEmployeeViewCell cell = collectionView.CellForItem(indexPath) as ReportChooseEmployeeViewCell;
            if (cell == null)
            {
