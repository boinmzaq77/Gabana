...
namespace Gabana.iOS
{
   ...
   public partial class ProfitReportController : UIViewController
    {
        ...
        ProfitReportMonthController MonthPage = null;
        ProfitReportTodayController TodayPage = null;
        ProfitReportYearController YearPAge = null;
        ...
        public override void ViewWillAppear(bool animated)
        {
            ...
            Utils.SetTitle(this.NavigationController , Utils.TextBundle("profitbycostestimate_report", "Items"));
            ...
            btnViewReport.TouchUpInside += async (sender, e) => {
                ...
                if (filterType == 0) // startdate - enddate
                {
                   if (string.IsNullOrEmpty(txtEndDate.Text))
                    ...
                    MonthPage = new ProfitReportMonthController(true, txtStartDate.Text + "-" + txtEndDate.Text, Start, End, filename);
                    this.NavigationController.PushViewController(MonthPage, false);
                }
                else if (filterType == 1) // today
                {
                    TodayPage = new ProfitReportTodayController();
                ...
                else if (filterType == 2) // month
                {
                    ...
                    MonthPage = new ProfitReportMonthController(false, "", startDate, endDate,"");
                    this.NavigationController.PushViewController(MonthPage, false);
                }
                else if (filterType == 3) //year
                {
                    YearPAge = new ProfitReportYearController();
