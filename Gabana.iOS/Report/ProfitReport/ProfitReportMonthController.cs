...
namespace Gabana.iOS
{
    ...
    public partial class ProfitReportMonthController : UIViewController
    {
        ...
        List<Gabana.ORM.Period.SummaryHourly> GetDataReportMonth;
        ...
        public ProfitReportMonthController(bool custom, string dateSet, string start, string end, string filename)
        {
        ...
        void initAttribute()
        {
            ...
            lbl_GraphHead_Daily.Text = Utils.TextBundle("profitsbydate", "Items");
            ...
            {
                var filterPage = new ReportFilter2Controller(5);
            ...
            lblSaleDaily.Text = Utils.TextBundle("profit", "Items");
        ...
        public void Daily(UIGestureRecognizer sender)
        {
            ...
            Utils.SetConstant(_contentView.Constraints, NSLayoutAttribute.Height, 1680);
            _contentView.LayoutIfNeeded();
        ...
        internal async void setupData()
        {
            try
            {
                ...
                {
                    reportSale = await CalReport.CalReportProfit(GetDataReportMonth);
                    #region Hour
                    ...
                    HourTimeCollectionView.DataSource = report_adapter_showHour;
                    HourTimeCollectionView.ReloadData();
                    var ltotalhour = DataCashingAll.setmerchantConfig.CURRENCY_SYMBOLS + " " + reportSale.reportHourlies.Sum(x => x.value).ToString("#,##0.00");
                    ...
                    ReportSaleDailyDataSource report_adapter_showDaily = new ReportSaleDailyDataSource(reportSale.reportDailies);
                    DaillyTimeCollectionView.DataSource = report_adapter_showDaily;
                    DaillyTimeCollectionView.ReloadData();
        ...
        public async void Share(UIGestureRecognizer sender)
        {
            try
            {
                ...
                ReportManager.createDetail("ProfitReport", file, reportSale, "Monthly", "Monthly", null, null, GetDataReportMonth, ReportController.listChooseBranch[0].SysBranchID.ToString(), lblBranch.Text);
            }
            catch (Exception ex)
            {
                Utils.ShowMessage(ex.Message);
