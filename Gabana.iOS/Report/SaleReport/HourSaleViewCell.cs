...
{
    public class HourSaleViewCell : UICollectionViewCell
    {
        UILabel lblname,lblSaleTotal;

        public HourSaleViewCell(IntPtr handle) : base(handle)
        {
        ...
        public bool Color
        {
            ...
            set
            {
                if (value)
                {
                    ContentView.BackgroundColor = UIColor.FromRGB(241, 250, 255);
                }
                else
                {
                    ContentView.BackgroundColor = UIColor.White;
