...
{
    public class ReportSaleDailyDataSource : UICollectionViewDataSource
    {
        public List<ReportDaily> reportSale;


        public ReportSaleDailyDataSource(List<ReportDaily> cus)
        {
            this.reportSale = cus;
            //lstCustomer
        }

        public void ReloadData(List<ReportDaily> cus)
        {
            this.reportSale = cus;
        }
        ...
        public override UICollectionViewCell GetCell(UICollectionView collectionView, NSIndexPath indexPath)
        {
            ...
            cell.Time = this.reportSale[(int)indexPath.Row].Dailyname;
            cell.Total = "00.00";
