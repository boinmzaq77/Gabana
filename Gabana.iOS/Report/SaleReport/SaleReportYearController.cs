...
namespace Gabana.iOS
{
    ...
    public partial class SaleReportYearController : UIViewController
    {
        ...
        private List<int> lstsysBranchID = new List<int>();
        ...
        public SaleReportYearController()
        {
        }
        ...
        internal async void setupData()
        {
            ...
            var GetDataReportYear = await GabanaAPI.GetDataReportSummaryHourly(sysbranIdSelect, startDate, endDate);

            reportSale = new ReportSale();
            if (GetDataReportYear != null && GetDataReportYear.Count != 0)
            {
                reportSale = await CalReport.CalReportSale(GetDataReportYear);
                #region Hour
        ...
        void initAttribute()
        {
            ...
            lbl_GraphHead_Monthly.Text = Utils.TextBundle("salesbymonth", "Items");
            ...
            btnfilter.TouchUpInside += (sender, e) =>
            {
                ...
                var filterPage = new ReportFilter2Controller(3);
            ...
            lblSaleMonthly.Text = Utils.TextBundle("sale", "Items");
        ...
        public void Monthly(UIGestureRecognizer sender)
        {
            ...
            Typetime = "Monthly";
            Utils.SetConstant(_contentView.Constraints, NSLayoutAttribute.Height, 950);
            _contentView.LayoutIfNeeded();
        }
        [Export("Weekly:")]
        public void Weekly(UIGestureRecognizer sender)
        {
            ...
            Typetime = "Weekly";
            Utils.SetConstant(_contentView.Constraints, NSLayoutAttribute.Height, 720);
            _contentView.LayoutIfNeeded();
        ...
        void SetupAutoLayout()
        {
           ...
           MonthlyLineView.HeightAnchor.ConstraintEqualTo(1).Active = true;
            ...
            Hour_timeView.HeightAnchor.ConstraintEqualTo(1060);
        ...
        public async void Share(UIGestureRecognizer sender)
        {
            try
            {
                ...
                var file = "SaleReport_" + datenamefile.ToString();
                ReportManager.createDetail("SalesReport", file, reportSale, "Year", Typetime, lblDate.Text, null,null, null, lblBranch.Text);
