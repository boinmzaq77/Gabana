...
{
    public partial class SaleReportBranchController : UIViewController
    {
        ...
        public SaleReportBranchController() 
        {
        ...
        public override void ViewWillAppear(bool animated)
        {
            ...
            Utils.SetTitle(this.NavigationController,Utils.TextBundle("salebybranch_report", "Items"));
        ...
        void initAttribute()
        {
            ...
            btnViewReport.TouchUpInside += async (sender, e) => {
                ...
                if (filterType ==0) // startdate - enddate
                {
                    ...
                    var MonthPage = new SaleReportBranchTodayController(4, txtStartDate.Text+"-"+txtEndDate.Text, Start, End, filename);
                    this.NavigationController.PushViewController(MonthPage, false);
                }
                else if(filterType == 1) // today
                {
                    var TodayPage = new SaleReportBranchTodayController(1);
                    this.NavigationController.PushViewController(TodayPage, false);
                }
                else if (filterType == 2) // month
                {
                    
                    var MonthPage = new SaleReportBranchTodayController(2);
                    this.NavigationController.PushViewController(MonthPage, false);
                }
                else if (filterType ==3) //year
                {
                    var YearPAge = new SaleReportBranchTodayController(3);
