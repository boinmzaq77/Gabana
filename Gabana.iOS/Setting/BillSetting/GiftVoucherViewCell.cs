...
{
    public class GiftVoucherViewCell : UICollectionViewCell
    {
        ...
        public GiftVoucherViewCell(IntPtr handle) : base(handle)
        {
            try
            {
                viewall = new UIView();
...
//                throw;
        ...
        public delegate void EmpSelectedDelegate(GiftVoucherViewCell indexPath);
        public event EmpSelectedDelegate OnItemSwipe;

        public delegate void EmpClearDelegate(GiftVoucherViewCell indexPath);
        public event EmpClearDelegate OnItemClear;

        public delegate void EmpdeleteDelegate(GiftVoucherViewCell indexPath);
