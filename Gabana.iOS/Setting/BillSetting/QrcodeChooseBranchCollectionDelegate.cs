...
{
    public class QrcodeChooseBranchCollectionDelegate : UICollectionViewDelegate
    {
        public override bool ShouldSelectItem(UICollectionView collectionView, NSIndexPath indexPath)
        {
            QrcodeChooseBranchViewCell cell = collectionView.CellForItem(indexPath) as QrcodeChooseBranchViewCell;
            if (cell == null)
            {
