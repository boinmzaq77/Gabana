...
{
    public class BranchSettingCollectionDelegate : UICollectionViewDelegate
    {
        public override bool ShouldSelectItem(UICollectionView collectionView, NSIndexPath indexPath)
        {
            BranchSettingViewCell cell = collectionView.CellForItem(indexPath) as BranchSettingViewCell;
            if (cell == null)
            {
