...
{
    public class BranchSettingViewCell : UICollectionViewCell
    {
        UILabel lblBranch;
        //UIView line;
        ...
        public BranchSettingViewCell(IntPtr handle) : base(handle)
        {
            viewall = new UIView();
        ...
        public delegate void branchSelectedDelegate(BranchSettingViewCell indexPath);
        public event branchSelectedDelegate OnItemSwipe;
        public delegate void branchdeleteDelegate(BranchSettingViewCell indexPath);
