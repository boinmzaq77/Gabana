...
#pragma warning disable CS1573 // Parameter 'origin' has no matching param tag in the XML comment for 'AxisBasedChart.DrawValueLabel(SKCanvas, Dictionary<ChartEntry, SKRect>, float, SKSize, SKSize, ChartEntry, float, float, float, float)' (but other parameters do)
...
#pragma warning restore CS1573 // Parameter 'origin' has no matching param tag in the XML comment for 'AxisBasedChart.DrawValueLabel(SKCanvas, Dictionary<ChartEntry, SKRect>, float, SKSize, SKSize, ChartEntry, float, float, float, float)' (but other parameters do)
        {
        ...
        private float GenerateSerieLegend(SKCanvas canvas, float lineHeight, float origin, int nbLine, float currentWidthUsed, ChartSerie serie)
        {
            ...
            var typeface1 = SKFontManager.Default.MatchCharacter(serie.Name[0]);
