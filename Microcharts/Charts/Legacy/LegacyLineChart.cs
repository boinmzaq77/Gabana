...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member 'LegacyLineChart.DrawLine(SKCanvas, SKPoint[], SKSize)'
        protected void DrawLine(SKCanvas canvas, SKPoint[] points, SKSize itemSize)
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member 'LegacyLineChart.DrawLine(SKCanvas, SKPoint[], SKSize)'
        {
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member 'LegacyLineChart.DrawArea(SKCanvas, SKPoint[], SKSize, float)'
        protected void DrawArea(SKCanvas canvas, SKPoint[] points, SKSize itemSize, float origin)
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member 'LegacyLineChart.DrawArea(SKCanvas, SKPoint[], SKSize, float)'
        {
