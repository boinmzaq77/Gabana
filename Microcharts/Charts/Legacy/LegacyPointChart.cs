...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member 'LegacyPointChart.DrawContent(SKCanvas, int, int)'
        public override void DrawContent(SKCanvas canvas, int width, int height)
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member 'LegacyPointChart.DrawContent(SKCanvas, int, int)'
        {
            if (Entries != null)
            {
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member 'LegacyPointChart.CalculateYOrigin(float, float)'
        protected float CalculateYOrigin(float itemHeight, float headerHeight)
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member 'LegacyPointChart.CalculateYOrigin(float, float)'
        {
            if (MaxValue <= 0)
            {
                return headerHeight;
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member 'LegacyPointChart.CalculateItemSize(int, int, float, float)'
        protected SKSize CalculateItemSize(int width, int height, float footerHeight, float headerHeight)
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member 'LegacyPointChart.CalculateItemSize(int, int, float, float)'
        {
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member 'LegacyPointChart.CalculatePoints(SKSize, float, float, float)'
        protected SKPoint[] CalculatePoints(SKSize itemSize, float origin, float headerHeight, float originX = 0)
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member 'LegacyPointChart.CalculatePoints(SKSize, float, float, float)'
        {
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member 'LegacyPointChart.DrawHeader(SKCanvas, string[], SKRect[], SKPoint[], SKSize, int, float)'
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member 'LegacyPointChart.DrawHeader(SKCanvas, string[], SKRect[], SKPoint[], SKSize, int, float)'
        {
            DrawLabels(canvas,
                            labels,
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member 'LegacyPointChart.DrawFooter(SKCanvas, string[], SKRect[], SKPoint[], SKSize, int, float)'
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member 'LegacyPointChart.DrawFooter(SKCanvas, string[], SKRect[], SKPoint[], SKSize, int, float)'
        {
            DrawLabels(canvas,
                            labels,
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member 'LegacyPointChart.DrawPoints(SKCanvas, SKPoint[])'
        protected virtual void DrawPoints(SKCanvas canvas, SKPoint[] points)
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member 'LegacyPointChart.DrawPoints(SKCanvas, SKPoint[])'
        {
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member 'LegacyPointChart.DrawAreas(SKCanvas, SKPoint[], SKSize, float, float)'
        protected virtual void DrawAreas(SKCanvas canvas, SKPoint[] points, SKSize itemSize, float origin, float headerHeight)
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member 'LegacyPointChart.DrawAreas(SKCanvas, SKPoint[], SKSize, float, float)'
        {
