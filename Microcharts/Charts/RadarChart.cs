...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member 'RadarChart.DrawContent(SKCanvas, int, int)'
        public override void DrawContent(SKCanvas canvas, int width, int height)
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member 'RadarChart.DrawContent(SKCanvas, int, int)'
        {
