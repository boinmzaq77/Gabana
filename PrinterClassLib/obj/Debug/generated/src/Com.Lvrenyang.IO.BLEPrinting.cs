...
namespace Com.Lvrenyang.IO {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.lvrenyang.io']/class[@name='BLEPrinting']"
	[global::Android.Runtime.Register ("com/lvrenyang/io/BLEPrinting", DoNotGenerateAcw=true)]
	public partial class BLEPrinting : global::Com.Lvrenyang.IO.IO {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/lvrenyang/io/BLEPrinting", typeof (BLEPrinting));
		...
		protected BLEPrinting (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.lvrenyang.io']/class[@name='BLEPrinting']/constructor[@name='BLEPrinting' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe BLEPrinting () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Lvrenyang.IO.BLEPrinting> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.Close ();
		}
#pragma warning restore 0169

		// Metadata.xml XPath method reference: path="/api/package[@name='com.lvrenyang.io']/class[@name='BLEPrinting']/method[@name='Close' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.lvrenyang.io']/class[@name='BLEPrinting']/method[@name='Open' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.lvrenyang.io']/class[@name='BLEPrinting']/method[@name='SetCallBack' and count(parameter)=1 and parameter[1][@type='com.lvrenyang.io.IOCallBack']]"
